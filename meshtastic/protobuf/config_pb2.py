...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CONFIG_DEVICECONFIG.fields_by_name['tzdef']._options = None
  _CONFIG_DEVICECONFIG.fields_by_name['tzdef']._serialized_options = b'\222?\002\010A'
  _CONFIG_DEVICECONFIG.fields_by_name['buzzer_mode']._options = None
  _CONFIG_DEVICECONFIG.fields_by_name['buzzer_mode']._serialized_options = b'\222?\0028\010'
  ...
  _CONFIG_POWERCONFIG.fields_by_name['device_battery_ina_address']._options = None
  _CONFIG_POWERCONFIG.fields_by_name['device_battery_ina_address']._serialized_options = b'\222?\0028\010'
  _CONFIG_NETWORKCONFIG.fields_by_name['wifi_ssid']._options = None
  _CONFIG_NETWORKCONFIG.fields_by_name['wifi_ssid']._serialized_options = b'\222?\002\010!'
  _CONFIG_NETWORKCONFIG.fields_by_name['wifi_psk']._options = None
  _CONFIG_NETWORKCONFIG.fields_by_name['wifi_psk']._serialized_options = b'\222?\002\010A'
  _CONFIG_NETWORKCONFIG.fields_by_name['ntp_server']._options = None
  _CONFIG_NETWORKCONFIG.fields_by_name['ntp_server']._serialized_options = b'\222?\002\010!'
  _CONFIG_NETWORKCONFIG.fields_by_name['rsyslog_server']._options = None
  _CONFIG_NETWORKCONFIG.fields_by_name['rsyslog_server']._serialized_options = b'\222?\002\010!'
  ...
  _CONFIG_LORACONFIG.fields_by_name['bandwidth']._options = None
  _CONFIG_LORACONFIG.fields_by_name['bandwidth']._serialized_options = b'\222?\0028\020'
  _CONFIG_LORACONFIG.fields_by_name['coding_rate']._options = None
  _CONFIG_LORACONFIG.fields_by_name['coding_rate']._serialized_options = b'\222?\0028\010'
  _CONFIG_LORACONFIG.fields_by_name['tx_power']._options = None
  _CONFIG_LORACONFIG.fields_by_name['tx_power']._serialized_options = b'\222?\0028\010'
  _CONFIG_LORACONFIG.fields_by_name['channel_num']._options = None
  _CONFIG_LORACONFIG.fields_by_name['channel_num']._serialized_options = b'\222?\0028\020'
  _CONFIG_LORACONFIG.fields_by_name['ignore_incoming']._options = None
  _CONFIG_LORACONFIG.fields_by_name['ignore_incoming']._serialized_options = b'\222?\002\020\003'
  _CONFIG_SECURITYCONFIG.fields_by_name['public_key']._options = None
  _CONFIG_SECURITYCONFIG.fields_by_name['public_key']._serialized_options = b'\222?\002\010 '
  _CONFIG_SECURITYCONFIG.fields_by_name['private_key']._options = None
  _CONFIG_SECURITYCONFIG.fields_by_name['private_key']._serialized_options = b'\222?\002\010 '
  _CONFIG_SECURITYCONFIG.fields_by_name['admin_key']._options = None
  _CONFIG_SECURITYCONFIG.fields_by_name['admin_key']._serialized_options = b'\222?\004\010 \020\003'
  _globals['_CONFIG']._serialized_start=129
  _globals['_CONFIG']._serialized_end=6455
  _globals['_CONFIG_DEVICECONFIG']._serialized_start=758
  _globals['_CONFIG_DEVICECONFIG']._serialized_end=1685
  _globals['_CONFIG_DEVICECONFIG_ROLE']._serialized_start=1249
  _globals['_CONFIG_DEVICECONFIG_ROLE']._serialized_end=1461
  _globals['_CONFIG_DEVICECONFIG_REBROADCASTMODE']._serialized_start=1463
  _globals['_CONFIG_DEVICECONFIG_REBROADCASTMODE']._serialized_end=1578
  _globals['_CONFIG_DEVICECONFIG_BUZZERMODE']._serialized_start=1580
  _globals['_CONFIG_DEVICECONFIG_BUZZERMODE']._serialized_end=1685
  _globals['_CONFIG_POSITIONCONFIG']._serialized_start=1688
  _globals['_CONFIG_POSITIONCONFIG']._serialized_end=2354
  _globals['_CONFIG_POSITIONCONFIG_POSITIONFLAGS']._serialized_start=2128
  _globals['_CONFIG_POSITIONCONFIG_POSITIONFLAGS']._serialized_end=2299
  _globals['_CONFIG_POSITIONCONFIG_GPSMODE']._serialized_start=2301
  _globals['_CONFIG_POSITIONCONFIG_GPSMODE']._serialized_end=2354
  _globals['_CONFIG_POWERCONFIG']._serialized_start=2357
  _globals['_CONFIG_POWERCONFIG']._serialized_end=2624
  _globals['_CONFIG_NETWORKCONFIG']._serialized_start=2627
  _globals['_CONFIG_NETWORKCONFIG']._serialized_end=3158
  _globals['_CONFIG_NETWORKCONFIG_IPV4CONFIG']._serialized_start=2997
  _globals['_CONFIG_NETWORKCONFIG_IPV4CONFIG']._serialized_end=3067
  _globals['_CONFIG_NETWORKCONFIG_ADDRESSMODE']._serialized_start=3069
  _globals['_CONFIG_NETWORKCONFIG_ADDRESSMODE']._serialized_end=3104
  _globals['_CONFIG_NETWORKCONFIG_PROTOCOLFLAGS']._serialized_start=3106
  _globals['_CONFIG_NETWORKCONFIG_PROTOCOLFLAGS']._serialized_end=3158
  _globals['_CONFIG_DISPLAYCONFIG']._serialized_start=3161
  _globals['_CONFIG_DISPLAYCONFIG']._serialized_end=4296
  _globals['_CONFIG_DISPLAYCONFIG_DEPRECATEDGPSCOORDINATEFORMAT']._serialized_start=3826
  _globals['_CONFIG_DISPLAYCONFIG_DEPRECATEDGPSCOORDINATEFORMAT']._serialized_end=3869
  _globals['_CONFIG_DISPLAYCONFIG_DISPLAYUNITS']._serialized_start=3871
  _globals['_CONFIG_DISPLAYCONFIG_DISPLAYUNITS']._serialized_end=3911
  _globals['_CONFIG_DISPLAYCONFIG_OLEDTYPE']._serialized_start=3913
  _globals['_CONFIG_DISPLAYCONFIG_OLEDTYPE']._serialized_end=4040
  _globals['_CONFIG_DISPLAYCONFIG_DISPLAYMODE']._serialized_start=4042
  _globals['_CONFIG_DISPLAYCONFIG_DISPLAYMODE']._serialized_end=4107
  _globals['_CONFIG_DISPLAYCONFIG_COMPASSORIENTATION']._serialized_start=4110
  _globals['_CONFIG_DISPLAYCONFIG_COMPASSORIENTATION']._serialized_end=4296
  _globals['_CONFIG_LORACONFIG']._serialized_start=4299
  _globals['_CONFIG_LORACONFIG']._serialized_end=5784
  _globals['_CONFIG_LORACONFIG_REGIONCODE']._serialized_start=4964
  _globals['_CONFIG_LORACONFIG_REGIONCODE']._serialized_end=5420
  _globals['_CONFIG_LORACONFIG_MODEMPRESET']._serialized_start=5423
  _globals['_CONFIG_LORACONFIG_MODEMPRESET']._serialized_end=5724
  _globals['_CONFIG_LORACONFIG_FEM_LNA_MODE']._serialized_start=5726
  _globals['_CONFIG_LORACONFIG_FEM_LNA_MODE']._serialized_end=5784
  _globals['_CONFIG_BLUETOOTHCONFIG']._serialized_start=5787
  _globals['_CONFIG_BLUETOOTHCONFIG']._serialized_end=5969
  _globals['_CONFIG_BLUETOOTHCONFIG_PAIRINGMODE']._serialized_start=5913
  _globals['_CONFIG_BLUETOOTHCONFIG_PAIRINGMODE']._serialized_end=5969
  _globals['_CONFIG_SECURITYCONFIG']._serialized_start=5972
  _globals['_CONFIG_SECURITYCONFIG']._serialized_end=6416
  _globals['_CONFIG_SECURITYCONFIG_PACKETSIGNATUREPOLICY']._serialized_start=6279
  _globals['_CONFIG_SECURITYCONFIG_PACKETSIGNATUREPOLICY']._serialized_end=6416
  _globals['_CONFIG_SESSIONKEYCONFIG']._serialized_start=6418
  _globals['_CONFIG_SESSIONKEYCONFIG']._serialized_end=6436
