...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "meshtastic.deviceonly_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DEVICESTATE.fields_by_name["node_db_lite"]._serialized_options = (
        b"\222?'\222\001$std::vector<meshtastic_NodeInfoLite>"
    )
